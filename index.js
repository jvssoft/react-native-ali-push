...
var AliyunPushNative =null;
var LocalEventEmitter = null;
const { NativeEventEmitter } = require('react-native');
if(Platform.OS=='android'){
    AliyunPushNative=require('react-native').NativeModules.AliyunPush;
    LocalEventEmitter=new NativeEventEmitter(AliyunPushNative)
}
...
export default class AliyunPush {
    ...
    static register = () => {
        return AliyunPushNative.register();
    }
    static getDeviceId = () => {
